...
@XmlType(propOrder = {
    ...
    "numAutDocSustento", "fechaEmisionDocSustento", "detalles"})
public class Destinatario {
    ...
    protected GuiaDetalles detalles;
    ...
    public GuiaDetalles getDetalles() {
        return detalles;
    }

    public void setDetalles(GuiaDetalles detalles) {
